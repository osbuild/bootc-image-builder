...
require (
	...
	github.com/osbuild/images v0.216.1-0.20251111070102-913beef1efed
...
replace github.com/osbuild/images => github.com/mvo5/images v0.0.0-20251113165820-8a75b8f51af8
