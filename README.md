...
| `pxe-tree`      | A stateless image useful in PXE network boot environments                                 |
...
The container image being built must have the `dracut-live` and  `squashfs-tools` packages installed.
