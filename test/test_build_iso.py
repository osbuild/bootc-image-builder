...
def test_container_iso_installs(tmp_path, build_container, container_ref):
    ...
    # and https://fedoraproject.org/wiki/Changes/BootLoaderUpdatesPhase1
    # and https://src.fedoraproject.org/rpms/shim/c/6580d59360db674f4580df062b09a4858e555d01?branch=rawhide
    # (with that we would need efi_src_dir)
