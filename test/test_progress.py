...
def test_progress_term_works_without_tty(tmp_path, container_storage, build_fake_container):
    output_path = tmp_path / "output"
    output_path.mkdir(exist_ok=True)
...
def test_progress_term_autoselect(tmp_path, container_storage, build_fake_container):
    output_path = tmp_path / "output"
    output_path.mkdir(exist_ok=True)
