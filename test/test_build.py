    ...
    for image_type in image_types:
        ...
        if generated_img.exists():
            ...
            results.append(ImageBuildResult(
                ...
                "root", ssh_keyfile_private_path,
                bib_output, journal_output))

    # generate new keyfile
    if not ssh_keyfile_private_path.exists():
        subprocess.run(["ssh-keygen", "-N", "", "-f", os.fspath(ssh_keyfile_private_path)], check=True)
    ...
    with tempfile.TemporaryDirectory() as tempdir:
        ...
        cmd.extend([
            *creds_args,
            build_container,
            container_ref,
            "--experimental-root-ssh-authorized-key", ssh_pubkey,
            *types_arg,
            *upload_args,
            *target_arch_args,
